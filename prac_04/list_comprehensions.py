...
# creates a list of all of the full_names in lowercase format
...
# creates a list of only the numbers that are greater than 9 from the numbers (not strings) just created
numbers_larger_than_9 = [number for number in numbers if number > 9]
print(numbers_larger_than_9)
